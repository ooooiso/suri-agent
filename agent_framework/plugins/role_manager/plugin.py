...
from agent_framework.plugins.role_manager.soul_parser import build_system_prompt, parse_soul
...
"""
    ...
    async def _create_suri(self) -> None:
        ...
        """
        template_path = Path(__file__).parent.parent.parent.parent / "roles" / "suri" / "soul.md"
