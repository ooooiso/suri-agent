...
| **Plugin** | 系统插件能力 | suri 开发/升级 → 用户确认 → 热注册 | `agent_framework/plugins/{type}/{plugin_name}/` | 系统有新的能力提供者 |
...
| Plugin | plugin 本身的版本控制 | `agent_framework/plugins/{type}/{name}/` | plugin_manager 版本切换 |
