...
| `diff` | string | 否 | 变更 diff |
| `timestamp` | string | 是 | 变更时间 |

### 发布事件

#### `doc_sync.suggestion_created`
| 字段 | 类型 | 必填 | 说明 |
|------|------|------|------|
| `suggestion_id` | string | 是 | 建议 ID |
| `source_file` | string | 是 | 源文件 |
| `target_doc` | string | 是 | 目标文档 |
| `change_summary` | string | 是 | 变更摘要 |
...
|------|------|------|------|
| `suggestion_id` | string | 是 | 建议 ID |
| `applied_at` | string | 是 | 应用时间 |
| `applied_by` | string | 是 | 应用者 |

#### `doc_sync.ignored`
| 字段 | 类型 | 必填 | 说明 |
|------|------|------|------|
| `suggestion_id` | string | 是 | 建议 ID |
| `ignored_by` | string | 是 | 忽略者 |
